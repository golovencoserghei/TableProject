...
<a class="btn btn-violet" href='report.html&sub=congr'> << Назад</a>
										...
										<thead>
												...
												<tr>
														...
														<?
																	...
																	if($permis[7]==1){
																	echo "<th><a id='edit' class='nav-link' href='report.html&sub=mbe&u=".$user."'><i data-feather='align-justify'></i></a>	</th>";
																	}
...
echo("<tr> <td colspan='6' bgcolor='#FA8072'>Нет ниодного отчета. Создать таблицу отчетов?</td> <th><form action=''  method='post' name='form1'>      <input type='hidden' name='rapy' value='".$rp_ye[0]."' ><button type='submit' class='btn btn-primary'>Содать</button>	</form></th></tr>");
}
else {
