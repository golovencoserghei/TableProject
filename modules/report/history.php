...
<div class='d-flex align-items-center justify-content-between mt-50 mb-20'>
				<h4>ИСТОРИЯ <p> Отчет за <? if ($mn == '')echo t_month();
								else echo nmonth($mn);
            ...
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=9&y=<? echo $year; ?>'>Сентябрь</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=10&y=<? echo $year; ?>'>Октябрь</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=11&y=<? echo $year; ?>'>Ноябрь</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=12&y=<? echo $year; ?>'>Декабрь</a>
			<a class="btn btn-sm btn-link" href='report.html&sub=history&mn=1&y=<? echo $year; ?>'>Январь</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=2&y=<? echo $year; ?>'>Февраль</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=3&y=<? echo $year; ?>'>Март</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=4&y=<? echo $year; ?>'>Апрель</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=5&y=<? echo $year; ?>'>Май</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=6&y=<? echo $year; ?>'>Июнь</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=7&y=<? echo $year; ?>'>Июль</a>
            <a class="btn btn-sm btn-link" href='report.html&sub=history&mn=8&y=<? echo $year; ?>'>Август</a>
			<a class="btn btn-sm btn-link" href='report.html&sub=history&y=<? echo $rp_ye[0]; ?>'><? echo $rp_ye[0]; ?></a>
			<a class="btn btn-sm btn-link" href='report.html&sub=history&y=<? echo $rp_ye[1]; ?>'><? echo $rp_ye[1]; ?></a>
