...
if($post_array['name']!=''){
		...
		$upgrade=mysql_query("UPDATE `users` SET `name`='".$post_array['name']."',
												 ...
												 `tel2`='".$post_array['tel2']."' WHERE `id`='".$get_array['uid']."'  AND `rid`='".$user_arr['rid']."'");
...
if ($post_array['dell']!=''){
	...
	$four=mysql_query("UPDATE `users` SET `rid`='0' WHERE `id`='".$get_array['uid']."' ");
  ...
  if ($post_array['npass']!=''){
		...
		$upgrade=mysql_query("UPDATE `users` SET `passw`='".md5($post_array['npass'])."' WHERE `id`='".$get_array['uid']."'  AND `rid`='".$user_arr['rid']."'");
  ...
  if ($post_array['lock']=='1'){
		...
		$upgrade=mysql_query("UPDATE `users` SET `prof_lock`='1' WHERE `id`='".$get_array['uid']."'  AND `rid`='".$user_arr['rid']."'");
		if($upgrade) msg("Данные обновлены!","ok");
  }
  if ($post_array['otv']=='1'){
		...
		$upgrade=mysql_query("UPDATE `users` SET `otvets`='".$otvets."',`group`='".$grt."',`stand`='".$stand."' WHERE `id`='".$get_array['uid']."'  AND `rid`='".$user_arr['rid']."'");
		if($upgrade) msg("Данные обновлены!","ok");
  }
...
<a class="btn btn-violet" href='member.html'> Главная</a>
                                    ...
                                    <div class="row">
										...
										<div class="form-group">
                                           <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck6">Удалить Возвещателя из списка собрания</label>
                                            </div>
                                        </div>
