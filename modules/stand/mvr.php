...
if($user_arr['stand']==0)
{
	...
	<ul class="nav nav-tabs  nav-tabs-line">
        ...
        <li class="nav-item">
            <a href="stand.html&p=n" class="nav-link"><? echo $st_nxw;?></a>
        </li>
        <li class="nav-item">
				 ...
				 echo("<tr><th></th><td"); } 
				  ...
				  echo(">".$us_name[0]." ");
					...
					if($cfg[0]==1 or $user_arr[4]!=1){
                        ...
                        echo("<a href='stand.html&sub=mdl&use=".$f_u[2]."&did=".$row[0]."&tid=".$key."&fid=".$row[2]."&ti=".str_replace([':'], ['f'], $value)."&token=".substr(md5($f_u[2].$row[0].$key.$row[2].str_replace([':'], ['f'], $value)),1,10)."	' alt='Выписать' title='Выписать' border='0'><img src='template/apimages/delete.png' width='20' height='20'></a>");
