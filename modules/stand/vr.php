...
if($f_u[0] == 0) {
                  ...
                  if($f_u[0] == 0) {
                    echo("<td><a  href='index.html&sub=partner&did=".$row[0]."&tid=".$key."&fid=".$row[2]."&ti=".str_replace([':'], ['f'], $value)."'><center><span style='color: green;'><i class='fa fa-plus' title='Записать напарника'></i></span></center></a></td><tr>");
                  } 
				  ...
				  if($cfg[1] == 1) {
					  if($user_arr[4]>1 ){
						  echo("<td><a  href='index.html&sub=raport&did=".$row[0]."&tid=".$key."&ti=".str_replace([':'], ['f'], $value)."'><center><span style='color: green;'><i class='fa fa-pencil'></i></span></center></a></td><tr>");
...
elseif($f_u[1] == 0) {
				  ...
				  if ($f_u[0]>0){ echo(" bgcolor='#FFA07A'"); } 
