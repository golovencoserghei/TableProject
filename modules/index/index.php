...
if($key==0 and $value=='00:00'){
    ...
    <tr>
      <td colspan='4' >Содержимое ячейки 1.1</td>
    </tr>

	<tr>
	   <td colspan='4' bgcolor='#FFA07A' ><font size='2' color='#000000' face='Arial'>".$st_inf_no."</font></td>
	</tr>
     ...
     if($f_u[0] == 0 or $f_u[1] == 0 ) {
              ...
              if($f_u[0] == 0) {
		          ...
		          $us_name=mysql_fetch_array(mysql_query("SELECT `name`,`id`,`tel1` FROM `users` WHERE `id`='".$f_u[1]."'"));
				  ...
				  if ($f_u[1]>0){ 
                    ...
                    echo("<a href='tel:".$us_name[2]."' alt='Позвонить' title='Позвонить' border='0'><span style='color: green;'><i class='fa fa-phone-square'></i></span></a> &nbsp;");
					  }
                  }
                  ...
                  if($f_u[1]!=0){
					  ...
					  if($cfg[0]==1 or $user_arr[4]!=1){
                    echo("<a href='index.html&sub=delete&use=".$f_u[1]."&did=".$row[0]."&tid=".$key."&fid=".$row[2]."&ti=".str_replace([':'], ['f'], $value)."' alt='Выписать' title='Выписать' border='0'><img src='template/apimages/delete.png' width='20' height='20'></a>");
					  }
                  }
                  echo("</td>");
                  ...
                  if($f_u[0] == 0) {
                    echo("<td><a  href='index.html&sub=partner&did=".$row[0]."&tid=".$key."&fid=".$row[2]."&ti=".str_replace([':'], ['f'], $value)."'><center><span style='color: green;'><i class='fa fa-plus' title='Записать напарника'></i></span></center></a></td>");
                  } 
              ...
              elseif($f_u[1] == 0) {
		              ...
		              $us_name=mysql_fetch_array(mysql_query("SELECT `name`,`id`,`tel1` FROM `users` WHERE `id`='".$f_u[0]."'"));
                  echo("<tr><th>".$value." </th><td"); 
				...
				echo("".$us_name[0]." ");
                        ...
                        echo("<a href='index.html&sub=delete&use=".$f_u[0]."&did=".$row[0]."&tid=".$key."&fid=".$row[2]."&ti=".str_replace([':'], ['f'], $value)."	' alt='Выписать' title='Выписать' border='0'><img src='template/apimages/delete.png' width='20' height='20'></a>");
        ...
        $user0=mysql_fetch_array(mysql_query("SELECT `name`,`id`,`tel1` FROM `users` WHERE `id`='".$f_u[0]."'"));
        $user1=mysql_fetch_array(mysql_query("SELECT `name`,`id`,`tel1` FROM `users` WHERE `id`='".$f_u[1]."'"));

	                   echo("<tr><th>".$value."");

                     

	                   echo("</th><td bgcolor='#90EE90'> <a href='tel:".$user0[2]."' alt='Позвонить' title='Позвонить' border='0'><span style='color: green;'><i class='fa fa-phone-square'></i></span></a> &nbsp;".$user0[0]."");
                     ...
                     if($user0[0]!=$user_arr[0] ){
	                   ...
	                   echo("</td><td bgcolor='#90EE90'>  <a href='tel:".$user1[2]."' alt='Позвонить' title='Позвонить' border='0'><span style='color: green;'><i class='fa fa-phone-square'></i></span></a> &nbsp;".$user1[0]."");
